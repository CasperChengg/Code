...
int main(int argc, char *argv[])
{
    ...
    InstanceHardnessThreshold IHT(dtc_params, 5); // 5-fold cross-validation
    std::vector<std::vector<float>> resampled_set = IHT.fit_resample(dataset.training_set, dataset.n_classes);
